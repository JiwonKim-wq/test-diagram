...
export class TransformEngine {
   ...
   */
  private applyTransformation(item: any, transformation: TransformationRule): void {
   ...
   * 문자열 부분 추출
   */
  private substring(value: any, params: any): string {
   ...
   * 문자열 치환
   */
  private replace(value: any, params: any): string {
    const str = String(value);
   ...
   * 문자열 연결
   */
  private concat(item: any, params: any): string {
   ...
   * 문자열 분할
   */
  private split(value: any, params: any): string[] {
    const str = String(value);
   ...
   * 날짜 포맷팅
   */
  private formatDate(value: any, params: any): string {
    const date = new Date(value);
   ...
   * 수학 연산
   */
  private mathOperation(value: any, params: any): number {
    const num = Number(value);
    if (isNaN(num)) {
   ...
   * 조건부 변환
   */
  private conditional(item: any, params: any): any {
   ...
   * 커스텀 함수 실행
   */
  private customFunction(value: any, params: any): any {
